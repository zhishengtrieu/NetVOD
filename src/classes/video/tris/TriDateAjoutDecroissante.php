...
use \PDO;
class TriDateAjoutDecroissante implements Tri
{
    // cette fonction permettera de trier les series du catalogue par datte d'ajot de la plus recente a la plus ancienne
    public function trier(): string
    {
        $res = "";
        //on créé un nouveau catalogue
        $catalogue = new Catalogue();
        //requete sql permettant de recuperer l'id et le titre des series et de les trier par ordre d'ajout decroissante
        $query = "select id,titre from serie order by date_ajout desc";
