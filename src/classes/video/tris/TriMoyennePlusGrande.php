...
{
    // cette fonction permettera de trier les series du catalogue par moyenne la plus grande a la plus petite
    public function trier(): string
    {
        $res = "";
        //on créé un nouveau catalogue
        $catalogue = new Catalogue();
        //requete sql permettant de recuperer l'id et le titre et la moyenne des series et de les trier par de la meilleur moyenne a la pire
